...
$games = @(
    ...
    @{
        ...
        Title = "Me & Society – Civics Life Skills Game for Kids | Medhaa"
        ...
        Schema = '{"@context": "https://schema.org", "@type": "LearningResource", "name": "Me & Society", "description": "Navigate branching real-life scenes where every response you choose shifts a visible relationship meter up or down.", "url": "https://medhaa.net/games-static/soccomm-enhanced.html", "learningResourceType": "Educational Game", "teaches": ["Social Responsibility", "Communication", "Negotiation"], "typicalAgeRange": "11-17", "isAccessibleForFree": true, "provider": {"@type": "Organization", "name": "Bhava Tech", "url": "https://medhaa.net"}}'
    },
    @{
    ...
    @{
        ...
        Schema = '{"@context": "https://schema.org", "@type": "LearningResource", "name": "MindSpark IQ", "description": "A structured IQ-style assessment covering pattern, spatial, verbal, and numerical reasoning.", "url": "https://medhaa.net/games-static/mindspark-iq.html", "learningResourceType": "Educational Game", "teaches": ["Pattern Recognition", "Spatial Reasoning", "Verbal & Numerical Reasoning"], "typicalAgeRange": "12-17", "isAccessibleForFree": true, "provider": {"@type": "Organization", "name": "Bhava Tech", "url": "https://medhaa.net"}}'
    },
    @{
        Path = "games-static\neuro-ascend-iq.html"
    ...
    @{
        ...
        Desc = "A lightweight version of Bhava's cognitive screening — a fast check-in on where you stand. Free game for ages 11-17 on Medhaa."
        Canonical = "https://medhaa.net/games-static/bcs-lite-v3.html"
        Schema = '{"@context": "https://schema.org", "@type": "LearningResource", "name": "BCS Lite", "description": "A lightweight version of Bhava's cognitive screening \u2014 a fast check-in on where you stand.", "url": "https://medhaa.net/games-static/bcs-lite-v3.html", "learningResourceType": "Educational Game", "teaches": ["Self-Awareness", "Baseline Cognitive Screening"], "typicalAgeRange": "11-17", "isAccessibleForFree": true, "provider": {"@type": "Organization", "name": "Bhava Tech", "url": "https://medhaa.net"}}'
    },
    @{
...
"@
    ...
    if ($content -match "<head[^>]*>") {
        $newContent = $content -replace "(<head[^>]*>)", "`$1`r`n$metaBlock"
