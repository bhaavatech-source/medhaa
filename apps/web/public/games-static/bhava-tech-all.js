...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var faqs = [
    ...
    },
    {
      ...
      a: 'Brain Gym at Medhā is a structured set of cognitive exercises designed to strengthen specific mental functions - just like physical gym exercises strengthen muscles. It includes memory training, attention exercises, pattern recognition tasks, and problem-solving games. Regular sessions build neural pathways, improve working memory, sharpen focus, and increase mental stamina. Results are typically noticeable within 4 to 6 weeks.'
    },
    {
      q: 'What methods and techniques does Medhā use?',
    ...
    {
      q: 'Can schools and institutions partner with Medhā?',
  ...
  var testis = [
    ...
    { name: 'Narasimha Rao',    role: 'Parent of Divya (Age 12)', stars: 5, quote: 'The team at Medhā is exceptional. The SQ test revealed intelligence areas we never thought to nurture. Highly recommended for every parent.' },
    ...
    { name: 'Dr. Padma Venkat', role: 'School Principal, Vizag',  stars: 5, quote: 'We partnered with Medhā for 60 students. The reports were professional and the Brain Gym sessions kept children genuinely engaged.' }
  ];
  ...
  if (nlForm) {
    nlForm.addEventListener('submit', function(e) {
      ...
      fetch(NL_URL, { method: 'POST', body: new FormData(nlForm) })
        .then(function(r) { if (!r.ok) throw new Error(); if (st) { st.textContent = 'Subscribed! You will receive Medhā updates.'; st.className = 'status-msg ok'; } nlForm.reset(); })
...
// ── END VALIDATOR ─────────────────────────────────────────────────────────
    ...
    el.innerHTML = `
      ...
      <div class="bv-box"><div class="bv-card">
        <div style="text-align:center;margin-bottom:18px;">
          ...
          <p class="bv-sub">You've been exploring Medhā for 15 minutes — subscribe to keep using Brain Games, Progress Tracking &amp; more.
  ...
  window.bvUnlock = function () {
    ...
    if (isValidCode(code)) {
      ...
      toast.textContent = "✅ Unlocked! Welcome to Medhā!";
