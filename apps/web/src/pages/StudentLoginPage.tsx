      ...
      <div className="student-login-card">
        ...
        {gated ? (
          <div className="student-login-gate-msg">
            <p>
              <strong>You've played 3 games as a guest.</strong>
            </p>
            <p>
              Log in to keep playing, save your progress, and track your growth.
            </p>
          </div>
        ) : (
          <p className="student-login-sub">
            Log in to save your progress and see your reports.
          </p>
        )}
        ...
        <form onSubmit={handleSubmit} className="student-login-form">
          ...
          <button
            type="submit"
            disabled={loading}
            className="student-login-btn-primary"
          >
        ...
        <p className="student-login-help">
          ...
          <a href="/signup/student">Sign up</a>
        </p>
      </div>
    </div>
  );
