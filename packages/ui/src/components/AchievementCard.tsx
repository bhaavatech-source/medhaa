...
// Badge/achievement card with unlock animation. Confetti fires once per
// unlock via the onUnlockAnimationEnd callback, never on every render.
...
export const AchievementCard: React.FC<AchievementCardProps> = ({
  ...
  return (
    <div
      ref={cardRef}
      className={`medhaa-achievement ${unlocked ? 'medhaa-achievement--unlocked' : 'medhaa-achievement--locked'} ${
    ...
    >
      ...
      {justUnlocked && <div className="medhaa-achievement__confetti" aria-hidden="true" />}
    </div>
  );
};
